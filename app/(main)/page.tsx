...
export default function Home() {
  return (
    <div className="min-h-screen bg-cloud flex flex-col relative overflow-hidden page-transition">
      ...
      {/* Header */}
      <header className="relative z-10 flex items-center p-4 sm:p-8 min-h-[80px] sm:min-h-[100px]">
        <div className="flex items-center gap-2 h-[25px] sm:h-[30px]">
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 py-12 gap-12">
        ...
        <div className="text-center max-w-[841px] mx-auto flex flex-col gap-6">
          <h1 className="font-sora font-extrabold text-3xl sm:text-4xl md:text-[58px] leading-tight md:leading-[66px] tracking-[-1px] text-black">
            Pay all of your credit cards with one payment
          </h1>
          <p className="font-satoshi font-medium text-base sm:text-lg md:text-[22px] leading-normal text-black">
      ...
      <footer className="relative z-10 max-w-[500px] mx-auto w-full px-0 py-8 flex flex-col gap-8">
        <div className="flex flex-col gap-1 items-center justify-center w-full">
          <p className="font-satoshi font-medium text-[11px] sm:text-[10px] leading-normal text-slate-100 text-center w-full">
          ...
          <div className="flex items-center justify-center gap-4 font-satoshi font-medium text-[11px] sm:text-[10px] leading-normal text-slate-100">
            ...
            <a href="https://help.getincredible.com" target="_blank" className="underline">
              Get Help
            </a>
          </div>
        </div>
